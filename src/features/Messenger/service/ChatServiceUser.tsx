  ...
  static connectWebSocket(
    ...
    this.stompClient.connect(
      ...
      (error) => {
        ...
        onError(error)
        this.attemptReconnect(token, user_code, onMessage, onConnect, onError)
      }
    )
  }
  ...
  private static attemptReconnect(
    ...
    if (this.reconnectAttempts < this.maxReconnectAttempts) {
      ...
      this.reconnectTimeout = setTimeout(
        () =>
          this.connectWebSocket(token, user_code, onMessage, onConnect, onError),
...
export default ChatServiceUser
