...
export const getChatStoryOwner = createAsyncThunk(
  ...
  async (data: IChatStoryRequest, { rejectWithValue }) => {
    try {
      ...
      return rejectWithValue(error.response?.data || 'Error fetching chat story');
    }
  }
);
...
const chatSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(getChatListOwner.fulfilled, (state, action: PayloadAction<IChatListResponse>) => {
        state.loading = false;
      ...
      .addCase(getChatStoryOwner.fulfilled, (state, action: PayloadAction<IChatDetail>) => {
        state.loading = false;
      ...
      .addCase(getChatListCustomer.fulfilled, (state, action: PayloadAction<IChatListResponse>) => {
        state.loading = false;
        state.chatList = action.payload;
      })
      ...
      .addCase(getChatStoryCustomer.fulfilled, (state, action: PayloadAction<IChatDetail>) => {
        state.loading = false;
        state.chatStory = action.payload;
      })
